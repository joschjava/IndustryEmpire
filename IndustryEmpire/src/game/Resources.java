...
public class Resources {
	...
	public static final ResourceSpec WOOD_DEB = new ResourceSpec("Wood", 12);
	...
	public static final ResourceSpec WOOD =  new ResourceSpec("Wood", "Wood.png", 12);
	public static final ResourceSpec BOOKS =  new ResourceSpec("Books", "book.png", 32);
